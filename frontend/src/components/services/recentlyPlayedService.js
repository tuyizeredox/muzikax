 ...
 */
var addRecentlyPlayed = function (trackId) { return __awaiter(void 0, void 0, void 0, function () {
    var response, errorData, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, makeAuthenticatedRequest("".concat(process.env.NEXT_PUBLIC_API_URL, "/api/recently-played"), {
                        method: 'POST',
            ...
            case 4:
                error_2 = _a.sent();
                console.error('Error adding track to recently played:', error_2);
                throw error_2;
 ...
 */
var getRecentlyPlayed = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_3 = _a.sent();
                console.error('Error fetching recently played tracks:', error_3);
                throw error_3;
